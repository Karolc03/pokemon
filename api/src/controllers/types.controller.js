...
const getType = async (req, res, next) => {
  try {
    ...
    // // bulkCreate=> insertar múltiples registros en la base de datos en una sola operación
    const allTypes = await Type.findAll();//para obtener todos los registros de tipo de la tabla "Type".
    res.json(allTypes);
